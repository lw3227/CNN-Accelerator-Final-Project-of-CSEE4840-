...
#
# Local project-scoped wrapper for cnn_mmio_interface.
# This mirrors the working lab3-hw pattern where custom IP lives under
# the project directory instead of depending on an external catalog cache.
