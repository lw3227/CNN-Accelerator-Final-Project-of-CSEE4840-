...
module tb_system_e2e;
  ...
  initial begin : main_test
    ...
    if (!$test$plusargs("NO_VCD")) begin
      $dumpfile("/user/stud/fall25/lw3227/vcd/tb_system_e2e.vcd");
  ...
  always @(posedge clk) begin
    if (u_dut.runner_done && u_dut.runner_layer_sel == 2'b00 &&
      ...
      for (l1d_i = 0; l1d_i < 961; l1d_i = l1d_i + 1) begin
        if (u_dut.u_sram_b.u_sram_B_wrapper.sram_B_inst.mem[l1d_i] !== l1_pool_rm[l1d_i]) begin
          l1d_err = l1d_err + 1;
          if (l1d_err <= 5)
            $display("DIAG_L1POOL: word[%0d] MISMATCH: got=%h exp=%h",
                     l1d_i,
                     u_dut.u_sram_b.u_sram_B_wrapper.sram_B_inst.mem[l1d_i],
                     l1_pool_rm[l1d_i]);
        end
      end
  ...
  always @(posedge clk) begin
    if (u_dut.u_top_fsm.state == 4'd11 && prev_top_fsm_state_d == 4'd10 && !l2_checked) begin
      ...
      for (l2_i = 0; l2_i < 196; l2_i = l2_i + 1) begin
        if (u_dut.u_sram_a.u_sram_A_wrapper.sram_A_inst.mem[561 + l2_i] !== l2_golden[l2_i])
          l2_err = l2_err + 1;
      end
      for (l2_i = 0; l2_i < 196; l2_i = l2_i + 1) begin
        if (u_dut.u_sram_a.u_sram_A_wrapper.sram_A_inst.mem[757 + l2_i] !== l2_golden[196 + l2_i])
          l2_err = l2_err + 1;
      end
      ...
      $display("DIAG_L2POOL[%0d]: pass0[0]: actual=%h exp=%h", active_case_id,
               u_dut.u_sram_a.u_sram_A_wrapper.sram_A_inst.mem[561], l2_golden[0]);
      $display("DIAG_L2POOL[%0d]: pass0[195]: actual=%h exp=%h", active_case_id,
               u_dut.u_sram_a.u_sram_A_wrapper.sram_A_inst.mem[756], l2_golden[195]);
      $display("DIAG_L2POOL[%0d]: pass1[0]: actual=%h exp=%h", active_case_id,
               u_dut.u_sram_a.u_sram_A_wrapper.sram_A_inst.mem[757], l2_golden[196]);
      $display("DIAG_L2POOL[%0d]: pass1[1]: actual=%h exp=%h", active_case_id,
               u_dut.u_sram_a.u_sram_A_wrapper.sram_A_inst.mem[758], l2_golden[197]);
      if (l2_err != 0)
  ...
  always @(posedge clk) begin
    if (u_dut.u_top_fsm.state == 4'd11 && !l3_input_checked) begin
      ...
      $display("  [561]=%h [562]=%h [563]=%h [564]=%h",
               u_dut.u_sram_a.u_sram_A_wrapper.sram_A_inst.mem[561],
               u_dut.u_sram_a.u_sram_A_wrapper.sram_A_inst.mem[562],
               u_dut.u_sram_a.u_sram_A_wrapper.sram_A_inst.mem[563],
               u_dut.u_sram_a.u_sram_A_wrapper.sram_A_inst.mem[564]);
    end
  end
  ...
  always @(posedge clk) begin
    if (u_dut.u_top_fsm.state == 4'd13 && prev_top_fsm_state_d == 4'd12 && !l3_checked) begin
      ...
      for (l3_i = 0; l3_i < 36; l3_i = l3_i + 1) begin
        if (u_dut.u_sram_b.u_sram_B_wrapper.sram_B_inst.mem[l3_i] !== l3_golden[l3_i])
          l3_err = l3_err + 1;
      end
      for (l3_i = 0; l3_i < 36; l3_i = l3_i + 1) begin
        if (u_dut.u_sram_b.u_sram_B_wrapper.sram_B_inst.mem[36 + l3_i] !== l3_golden[36 + l3_i])
          l3_err = l3_err + 1;
      end
      ...
      if (l3_err > 0) begin
        $display("DIAG_L3POOL[%0d]: pass0[0]: actual=%h exp=%h", active_case_id,
                 u_dut.u_sram_b.u_sram_B_wrapper.sram_B_inst.mem[0], l3_golden[0]);
        $display("DIAG_L3POOL[%0d]: pass1[0]: actual=%h exp=%h", active_case_id,
                 u_dut.u_sram_b.u_sram_B_wrapper.sram_B_inst.mem[36], l3_golden[36]);
      end
      if (l3_err != 0)
